...
exp_name = "broccoli_004"
dataset_type = 'NeuSDataset'
...
if True:
    dataset_aabb = {"broccoli_004": 2, "Car": 4, "Coffee": 1, "Easyship": 8, "Scar": 5, "Scarf": 8}
    dataset_scale = {"broccoli_004": None, "Car": None, "Coffee": None, "Easyship": None, "Scar": None, "Scarf": 0.05}
    dataset_offset = {"broccoli_004": None, "Car": [-2.0, -0.5, 0.0], "Coffee": None, "Easyship": None, "Scar": None,
                      "Scarf": None}
    ...
    dataset = dict(
        train=dict(
            ...
            render_cameras_name=render_cameras_name,
            object_cameras_name=object_cameras_name
        ),
        val=dict(
            type=dataset_type,
            dataset_dir=dataset_dir,
